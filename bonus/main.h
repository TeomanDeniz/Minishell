...
/* ************************ [^] ./docs/here_doc [^] ************************* */
/* *********************** [v] ./docs/operate_doc [v] *********************** */
extern void	operate_doc(t_shell shell);
extern void	add_just_one_char(t_shell shell, char character);
extern bool	check_operate_doc(t_shell shell);
/* ************************ [^] ./docs/quate_doc [^] ************************ */
/* ***************************** [^] ./docs [^] ***************************** */
...
extern bool	check_brackets(register char character);
/* **************************** [^] ./syntax [^] **************************** */
